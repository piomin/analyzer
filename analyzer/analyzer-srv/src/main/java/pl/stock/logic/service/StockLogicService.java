...
public class StockLogicService {
	...
	for (Company company : companies) {
	    ...
	    try {
		// find daily quote history and last statistic record from
		// database
	...
	List<StatisticRecord> statistics = statisticService.findByDatePeriod(calendar.getTime(), date);
